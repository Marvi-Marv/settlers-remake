...
public final class GfxConstants {
    ...
    public static final int[][] XY_OFFSET_SMOKE_IRONMELT = {{-7, -9},{-4, -5},{-6, -8},{-6, -9}};
    public static final int[][] XY_OFFSET_METAL_IRONMELT = {{0, 0},{0, 0},{0, 0},{0, 0}};
    public static final int[][] XY_OFFSET_SMOKE_GOLDMELT = {{-7, -10},{-4, -5},{-5, -5},{-7, -10}};
    ...
    public static final int[][] XY_OFFSET_SMOKESMITH_WEAPONSMITH = {{-3, -2},{-2, 0},{-3, -2},{-3, -2}};
